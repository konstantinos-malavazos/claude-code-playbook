...
| 2 | **The stub builds and runs** | Not the app — there is no app. The framework's skeleton compiles and starts. *A green test command is optional here; the tail's **first** ticket decides whether this stack gates on one — it is a stack question. See [06-choosing-the-stack.md](06-choosing-the-stack.md#what-ticket-1-decides--and-what-it-writes).* |
...
invented ideas through the gate — one of them killed — and the survivor through all four
stages to the seam.
