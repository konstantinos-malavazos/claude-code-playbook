...
below every table a session actually recomputes, so nothing forces a reader past it. If you
resolve a ticket, rewrite this block even when nothing else about it changed.
